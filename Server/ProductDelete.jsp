	...
	<%
		...
		try	{
			...
			while(rs.next())	{
				...
				out.println("<tr><td>" + id + "</td><td>" + name + "</td><td>" + price + "</td><td>" + discount + "</td><td><a href='DeleteProductResult.jsp?id="+ id +"' target='_blank' class='btn btn-danger btn-lg btn-block'>삭제</a></td></tr>");
			}
