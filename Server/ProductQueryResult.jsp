...
<body>
	...
	<%
		...
		try	{
			...
			String sql = "select product.product_id, product.product_name, product.price, product.discount, brand.brand_name, kind.kind_name from product, brand, kind where product.brand_id = brand.brand_id and kind.kind_id = brand.kind_id";
			...
			while(rs.next())	{
				...
				if(request.getParameter("product_name").equals(rs.getString("product_name")))
				{
					flag = 1;
					...
					out.println("<tr><td>" + id + "</td><td>" + name + "</td><td>" + price + "</td><td>" + discount + "</td></tr>");
				}
				else if(request.getParameter("brand_name").equals(rs.getString("brand_name")))
				{
					flag = 1 ;
				...
				else if (request.getParameter("kind_name").equals(rs.getString("kind_name")))
				{	
					String id = rs.getString("product_id");
					String name = rs.getString("product_name");
					String price = rs.getString("price");
