	...
	<%
		...
		try	{
			...
			while(rs.next())	{
				...
				out.println("<tr><td>" + id + "</td><td>" + name + "</td><td>" + pw + "</td><td>" + phone + "</td><td>" + point + "</td><td>" + "<a href='DeleteUser.jsp?id="+ id +"' target='_blank' class='btn btn-danger btn-lg btn-block'>탈퇴</a></td></tr>");
			}
